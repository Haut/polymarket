...
let test_sort_direction_to_string () =
  Test_utils.test_string_conversions
    ~to_string:string_of_sort_direction
    [(ASC, "ASC"); (DESC, "DESC")]

let test_sort_direction_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_sort_direction
    ~of_json:sort_direction_of_yojson
    ~equal:equal_sort_direction
    ~to_string:string_of_sort_direction
    [ASC; DESC]
...
let test_position_sort_by_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_position_sort_by
    ~of_json:position_sort_by_of_yojson
    ~equal:equal_position_sort_by
    ~to_string:string_of_position_sort_by
...
let test_filter_type_to_string () =
  Test_utils.test_string_conversions
    ~to_string:string_of_filter_type
    [(CASH, "CASH"); (TOKENS_FILTER, "TOKENS")]

let test_filter_type_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_filter_type
    ~of_json:filter_type_of_yojson
    ~equal:equal_filter_type
    ~to_string:string_of_filter_type
    [CASH; TOKENS_FILTER]
...
let test_activity_sort_by_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_activity_sort_by
    ~of_json:activity_sort_by_of_yojson
    ~equal:equal_activity_sort_by
    ~to_string:string_of_activity_sort_by
...
let test_closed_position_sort_by_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_closed_position_sort_by
...
let test_time_period_to_string () =
  Test_utils.test_string_conversions
    ~to_string:string_of_time_period
    [(DAY, "DAY"); (WEEK, "WEEK"); (MONTH, "MONTH"); (ALL, "ALL")]

let test_time_period_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_time_period
    ~of_json:time_period_of_yojson
    ~equal:equal_time_period
    ~to_string:string_of_time_period
    [DAY; WEEK; MONTH; ALL]
...
let test_leaderboard_category_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_leaderboard_category
    ~of_json:leaderboard_category_of_yojson
    ~equal:equal_leaderboard_category
    ~to_string:string_of_leaderboard_category
...
let test_leaderboard_order_by_to_string () =
  Test_utils.test_string_conversions
    ~to_string:string_of_leaderboard_order_by
    [(PNL, "PNL"); (VOL, "VOL")]

let test_leaderboard_order_by_roundtrip () =
  Test_utils.test_roundtrip
    ~to_json:yojson_of_leaderboard_order_by
    ~of_json:leaderboard_order_by_of_yojson
    ~equal:equal_leaderboard_order_by
    ~to_string:string_of_leaderboard_order_by
    [PNL; VOL]
