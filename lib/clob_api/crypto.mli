(** Cryptographic utilities for CLOB API authentication.

    This module provides EIP-712 signing for L1 authentication and HMAC-SHA256
    signing for L2 authentication. *)
