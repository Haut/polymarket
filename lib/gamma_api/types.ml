...
let empty_image_optimization : image_optimization =
  {
    ...
    image_url_optimized = None;
    image_size_kb_source = None;
    image_size_kb_optimized = None;
    image_optimized_complete = None;
    image_optimized_last_updated = None;
    rel_id = None;
    field = None;
    relname = None;
  }
...
let empty_related_tag : related_tag =
  { id = None; tag_id = None; related_tag_id = None; rank = None }
...
let empty_event_creator : event_creator =
  {
    id = None;
    creator_name = None;
    creator_handle = None;
...
let empty_collection : collection =
  {
    id = None;
    ticker = None;
    slug = None;
    ...
    icon_optimized = None;
    header_image_optimized = None;
  }

let empty_series_summary : series_summary =
  {
    id = None;
    title = None;
    slug = None;
...
let empty_event : event =
  {
    ...
    cyom = None;
    closed_time = None;
    show_all_outcomes = None;
    show_market_images = None;
    automatically_resolved = None;
    enable_neg_risk = None;
    automatically_active = None;
    event_date = None;
    start_time = None;
    event_week = None;
    ...
    templates = [];
    spreads_main_line = None;
    totals_main_line = None;
    carousel_map = None;
    pending_deployment = None;
    deploying = None;
    deploying_timestamp = None;
