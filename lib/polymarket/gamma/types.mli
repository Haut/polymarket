...
type image_optimization = {
  ...
  image_size_kb_source : Common.Primitives.Decimal.t option;
  image_size_kb_optimized : Common.Primitives.Decimal.t option;
...
type clob_reward = {
  ...
  rewards_amount : Common.Primitives.Decimal.t option;
  rewards_daily_rate : Common.Primitives.Decimal.t option;
...
type market = {
  ...
  order_price_min_tick_size : Common.Primitives.Decimal.t option;
  order_min_size : Common.Primitives.Decimal.t option;
  uma_resolution_status : string option;
  curation_order : int option;
  volume_num : Common.Primitives.Decimal.t option;
  liquidity_num : Common.Primitives.Decimal.t option;
  ...
  comments_enabled : bool option;
  volume_24hr : Common.Primitives.Decimal.t option;
  volume_1wk : Common.Primitives.Decimal.t option;
  volume_1mo : Common.Primitives.Decimal.t option;
  volume_1yr : Common.Primitives.Decimal.t option;
  ...
  volume_24hr_amm : Common.Primitives.Decimal.t option;
  volume_1wk_amm : Common.Primitives.Decimal.t option;
  volume_1mo_amm : Common.Primitives.Decimal.t option;
  volume_1yr_amm : Common.Primitives.Decimal.t option;
  volume_24hr_clob : Common.Primitives.Decimal.t option;
  volume_1wk_clob : Common.Primitives.Decimal.t option;
  volume_1mo_clob : Common.Primitives.Decimal.t option;
  volume_1yr_clob : Common.Primitives.Decimal.t option;
  volume_amm : Common.Primitives.Decimal.t option;
  volume_clob : Common.Primitives.Decimal.t option;
  liquidity_amm : Common.Primitives.Decimal.t option;
  liquidity_clob : Common.Primitives.Decimal.t option;
  ...
  competitive : Common.Primitives.Decimal.t option;
  rewards_min_size : Common.Primitives.Decimal.t option;
  rewards_max_spread : Common.Primitives.Decimal.t option;
  spread : Common.Primitives.Decimal.t option;
  automatically_resolved : bool option;
  one_day_price_change : Common.Primitives.Decimal.t option;
  one_hour_price_change : Common.Primitives.Decimal.t option;
  one_week_price_change : Common.Primitives.Decimal.t option;
  one_month_price_change : Common.Primitives.Decimal.t option;
  one_year_price_change : Common.Primitives.Decimal.t option;
  last_trade_price : Common.Primitives.Decimal.t option;
  ...
  line : Common.Primitives.Decimal.t option;
...
and event = {
  ...
  featured : bool option;
  restricted : bool option;
  liquidity : Common.Primitives.Decimal.t option;
  volume : Common.Primitives.Decimal.t option;
  open_interest : Common.Primitives.Decimal.t option;
  sort_by : string option;
  category : string option;
  ...
  spreads_main_line : Common.Primitives.Decimal.t option;
  totals_main_line : Common.Primitives.Decimal.t option;
